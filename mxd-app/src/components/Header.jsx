export default function Header({ restaurant }) {
  return (
    <header className="mxd-header">
      <svg className="mxd-crown" viewBox="0 0 100 90" fill="none" stroke="#C9A227" strokeWidth="5" strokeLinecap="round">
      ...
      <h1>{restaurant?.name || 'MXD مكسد'}</h1>
      <div className="mxd-tagline">{restaurant?.tagline}</div>
      <div className="mxd-gold-rule"></div>
    </header>
  );
}
